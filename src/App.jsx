...
const MainApp = () => {
  ...
  const getBgClass = () => {
    switch (activeTab) {
      case 'dashboard': return 'bg-app-dashboard';
      case 'history': return 'bg-app-history';
      case 'master': return 'bg-app-admin';
      case 'shift': return 'bg-app-shift';
      default: return 'bg-stone-50';
    }
  };

  return (
    <div className={`min-h-screen ${getBgClass()} text-stone-800 font-sans transition-all duration-500`}>
      {/* Header */}
